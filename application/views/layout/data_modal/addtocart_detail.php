...
<script>
    $(document).ready(function() {
        ...
        if (data_diskon == '') {
            ...
            $('.new-price-addtocart').html(data_hrg_awal);
        } else {
            $('.percentage-addtocart, .old-price-addtocart').show();
            $('.new-price-addtocart').html(data_hrg_diskon);
            $('.percentage-addtocart').html('-' + data_diskon + '%');
            $('.old-price-addtocart').html('Rp' + data_hrg_awal);
        }
    });
</script>