...
<div id="modal-panel" class="top_panel">
    ...
    <div id="form-buat-pesanan-addtocart" class="mt-4">
        ...
        <div class="container detail-cart" style="position:relative;">
            <div id="loader-add-tocart" class="loader-container">
                <div class="loader">
                    <span class="loader__element"></span>
                    <span class="loader__element"></span>
                    <span class="loader__element"></span>
            ...
            <div class="row mt-2">
                <div class="col-lg-12">
                    <div class="alert alert-primary" id="alert-make-checkout" role="alert">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12 ">
                    ...
                    <!-- end mode bayar -->
                    <label class="control-label" for=""><i class="fa-regular fa-credit-card"></i> Detail Pembayaran</label>
                    <div class="box_cart pt-1">
                        ...
                        <a href="#" id="btn-beli-sekarang">
                            <button type="button" class="btn btn-success btn-block cart"><strong>Bayar Sekarang</strong></button>
                        </a>
                    </div>
                </div>
                <!-- </div> -->
